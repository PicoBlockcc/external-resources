...
function addGenerator (Blockly) {
    ...
    Blockly.Arduino.picoLabSensors_setRgbLedColor = function () {
        ...
        Blockly.Arduino.includes_.picoLabSensors_setRgbLedColor = '#include <RGBLed.h>';
        Blockly.Arduino.definitions_.picoLabSensors_setRgbLedColor = 'RGBLed *rgb = mMotorDriver.getSensor(E_RGB);';
    ...
    Blockly.Arduino.picoLabSensors_ps2ReadData = function () {
        ...
        Blockly.Arduino.definitions_.picoLabSensors_ps2ReadData = 'PS2X *ps2x;';
        Blockly.Arduino.setups_.picoLabSensors_ps2ReadData = 'ps2x = mMotorDriver.getSensor(E_PS2X);';

        return 'ps2x->read_gamepad();\n';
    };

    Blockly.Arduino.picoLabSensors_ps2GetButton = function () {
    ...
    Blockly.Arduino.picoLabSensors_ps2GetJoystick = function () {
    ...
    Blockly.Arduino.picoLabSensors_rgbUltrasonicInit = function () {
        const ultraPin = this.getFieldValue('ultraPin');
        const rgbPin = this.getFieldValue('rgbPin');
        Blockly.Arduino.includes_.picoLabSensors_rgbUltrasonicInit = `#include "RgbUltrasonic.h"\nRgbUltrasonic mRUS04(${ultraPin}, ${rgbPin});`;

        return '';
    };

    Blockly.Arduino.picoLabSensors_rgbUltrasonicSetColorStyle = function () {
        const no = this.getFieldValue('no');
    ...
    Blockly.Arduino.picoLabSensors_rgbUltrasonicReadDistance = function () {
